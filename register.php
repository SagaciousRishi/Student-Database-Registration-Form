...
<link href="https://fonts.googleapis.com/css2?family=Abril+Fatface&display=swap" rel="stylesheet">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item ">
        <a class="nav-link" href="index.html" style = "color : #951C49">Home</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="register.php" style = "color : #951C49">Register<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<form action="" method="post">
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="username" id="inputEmail4" placeholder="Enrollment Number">
    </div>
    <div class="form-group col-md-6">
